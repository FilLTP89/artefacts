...
tag="original";
% Astra:
addpath('/usrtmp/fgatti/astra/matlab/mex/')
addpath('/usrtmp/fgatti/astra/matlab/tools/')
...
% Run reconstruction
astra_mex_algorithm('iterate', id_alg, 1);

cfg.type = 'SIRT3D_CUDA';
id_alg = astra_mex_algorithm('create', cfg);
% Run reconstruction
astra_mex_algorithm('iterate', id_alg, 100);
...
save("reconstruction_"+tag,"Vol","-v7.3")
end
