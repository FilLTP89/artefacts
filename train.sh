...
#python3 train.py --model VGG19 --epochs 20 --batch_size 32 --wandb --saving_path "model/saved_models/VGG19/" --dicom --learning_rate 1.5e-4
...
python3 train.py --model MedGAN --epochs 5 --batch_size 3 --dicom --learning_rate 2e-6
#python3 train.py --model DeepMAR --epochs 5 --batch_size 3 --dicom 
