...
python3 train.py --model MedGAN --epochs 20 --batch_size 3 --wandb --saving_path "model/saved_models/MedGAN/" --dicom --learning_rate 4e-6 --save_weights 
#python3 train.py --model ResUnet --epochs 20 --batch_size 8 --wandb --saving_path "model/saved_models/ResUnet/" --big_endian
#python3 train.py --model MedGAN --epochs 10 --batch_size 1 --dicom  --one_batch_training --learning_rate 2e-6 --wandb --saving_path "model/saved_models/MedGAN/" --save_weights
