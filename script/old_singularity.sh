...
start_container_cmd="singularity exec \
    --pwd /gpfs/users/gabrielihu/artefacts \
    --bind /home/${USER}/:/home/${USER}/ \
    --bind /gpfs/workdir/gabrielihu/artefacts:/gpfs/users/gabrielihu/artefacts \
    --nv \
    $WORKDIR/artefacts/lightning_latest.sif"
