...
class DeepMAR(tf.keras.Model):
    ...
    def BuildModels(self):
        ...
        self.d_bn1 = kl.BatchNormalization(momentum = 0.9, 
                                           epsilon=1e-5, 
                                           name='d_bn1')
        self.d_bn2 = kl.BatchNormalization(momentum = 0.9, 
                                           epsilon=1e-5, 
                                           name='d_bn2')
        self.d_bn3 = kl.BatchNormalization(momentum = 0.9, 
                                           epsilon=1e-5, 
                                           name='d_bn3')
        self.d_bn4 = kl.BatchNormalization(momentum = 0.9, 
                                           epsilon=1e-5, 
                                           name='d_bn4')
        self.d_bn5 = kl.BatchNormalization(momentum = 0.9, 
                                           epsilon=1e-5, 
                                           name='d_bn5')
        self.d_bn6 = kl.BatchNormalization(momentum = 0.9, 
                                           epsilon=1e-5, 
                                           name='d_bn6')

        self.g_bn_e2 = kl.BatchNormalization(momentum = 0.9, 
                                             epsilon=1e-5, 
                                             name='g_bn_e2')
        self.g_bn_e3 = kl.BatchNormalization(momentum = 0.9, 
                                             epsilon=1e-5, 
                                             name='g_bn_e3')
        self.g_bn_e4 = kl.BatchNormalization(momentum = 0.9, 
                                             epsilon=1e-5, 
                                             name='g_bn_e4')
        self.g_bn_e5 = kl.BatchNormalization(momentum = 0.9, 
                                             epsilon=1e-5, 
                                             name='g_bn_e5')
        self.g_bn_e6 = kl.BatchNormalization(momentum = 0.9, 
                                             epsilon=1e-5, 
                                             name='g_bn_e6')

        self.g_bn_d3 = kl.BatchNormalization(momentum = 0.9, 
                                             epsilon=1e-5, 
                                             name='g_bn_d3')
        self.g_bn_d4 = kl.BatchNormalization(momentum = 0.9, 
                                             epsilon=1e-5, 
                                             name='g_bn_d4')
        self.g_bn_d5 = kl.BatchNormalization(momentum = 0.9, 
                                             epsilon=1e-5, 
                                             name='g_bn_d5')
        self.g_bn_d6 = kl.BatchNormalization(momentum = 0.9, 
                                             epsilon=1e-5, 
                                             name='g_bn_d6')
        self.g_bn_d7 = kl.BatchNormalization(momentum = 0.9, 
                                             epsilon=1e-5, 
                                             name='g_bn_d7')
    ...
    def BuildGX(self):
        X = kl.Input(shape=(self.imageWidth,
                            self.imageHeight,
                            self.nXchannels),
                     dtype=tf.float32,
                     name='incomplete_sinograms')
        Xp = kl.ZeroPadding2D(padding=(24, 24))(X)
        self.e1 = kl.Conv2D(filters=self.nFiltersGenerator,
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh, 
                                     self.dw),
                            padding="same",
                            kernel_initializer=ki.TruncatedNormal(
                                mean=0.0,
                                stddev=self.stddev),
                            bias_initializer="zeros",
                            name='g_e1_conv')(Xp)
        e1a = kl.LeakyReLU(alpha=0.2)(self.e1)
        self.e2 = kl.Conv2D(filters=self.nFiltersGenerator * 2,
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        self.e3 = kl.Conv2D(filters=self.nFiltersGenerator * 4,
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        self.e4 = kl.Conv2D(filters=self.nFiltersGenerator * 8, 
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        self.e5 = kl.Conv2D(filters=self.nFiltersGenerator * 8,
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        self.e6 = kl.Conv2D(filters=self.nFiltersGenerator * 8,
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        self.d3 = kl.Conv2DTranspose(filters=self.nFiltersGenerator * 8,
                                     kernel_size=(self.kh,
                                                  self.kw),
        ...
        self.d4 = kl.Conv2DTranspose(filters=self.nFiltersGenerator * 8,
                                     kernel_size=(self.kh,
                                                  self.kw),
                                     strides=(self.dh,
                                              self.dw),
        ...
        self.d5 = kl.Conv2DTranspose(filters=self.nFiltersGenerator * 4,
                                     kernel_size=(self.kh,
                                                  self.kw),
                                     strides=(self.dh,
                                              self.dw),
        ...
        self.d6 = kl.Conv2DTranspose(filters=self.nFiltersGenerator * 2,
                                     kernel_size=(self.kh,
                                                  self.kw),
                                     strides=(self.dh,
                                              self.dw),
        ...
        self.d7 = kl.Conv2DTranspose(filters=self.nFiltersGenerator,
                                     kernel_size=(self.kh,
                                                  self.kw),
                                     strides=(self.dh,
                                              self.dw),
        ...
        d7 = kl.Dropout(noise_shape=(self.batchSize, 
                                     1, 
                                     1, 
                                     2*self.nFiltersGenerator))(d7)
        d7a = kl.Activation('relu')(d7)
        
        Xhat = kl.Conv2DTranspose(filters=self.output_c_dim,
                                  kernel_size=(self.kh,
                                               self.kw),
                                  strides=(self.dh,
                                           self.dw),
    ...
    def BuildDX(self):
        ...
        X = kl.Input(shape=(self.batchSize, 1024, 768,
                            self.nXchannels),
                     dtype=tf.float32,
                     name='incomplete_sinograms')
        # image,
        ...
        self.h0 = kl.Conv2D(filters=self.nFiltersDiscriminator,     
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
                            padding="same",
                            kernel_initializer=ki.TruncatedNormal(mean=0.0, 
                                                                  stddev=self.stddev),
                            bias_initializer="zeros",
                            name='dh0_conv')(self.image)
        h0 = kl.LeakyReLU(alpha=0.2)(self.h0)
        self.h1 = kl.Conv2D(filters=self.nFiltersDiscriminator * 2, 
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        self.h2 = kl.Conv2D(filters=self.nFiltersDiscriminator * 4, 
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        self.h3 = kl.Conv2D(filters=self.nFiltersDiscriminator * 8, 
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        self.h4 = kl.Conv2D(filters=self.nFiltersDiscriminator * 8, 
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        self.h5 = kl.Conv2D(filters=self.nFiltersDiscriminator * 8, 
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        self.h6 = kl.Conv2D(filters=self.nFiltersDiscriminator * 8, 
                            kernel_size=(self.kh,
                                         self.kw),
                            strides=(self.dh,
                                     self.dw),
        ...
        h7f = kl.Flatten(h6)
        p_X = kl.Dense(activation='sigmoid',
                      kernel_initializer=ki.TruncatedNormal(mean=0.0,
                                                            stddev=self.stddev),
                      bias_initializer="zeros", 
                      name='dh7_lin')(h7f)
        
        D_X = tf.keras.Model(inputs=X,
                             outputs=p_X,
                             name="DX")
        return D_X
