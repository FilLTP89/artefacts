...
python3 train.py --model MedGAN --epochs 200 --batch_size 6 --wandb --saving_path "model/saved_models/MedGAN/" --big_endian --no-dicom --learning_rate 4e-6 --save_weights --pretrained_MedGAN
